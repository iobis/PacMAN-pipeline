...
if (R.utils::isAbsolutePath(config$meta$sampling$sample_data_file)) {
  sample_data_file <- config$meta$sampling$sample_data_file
} else {
  sample_data_file <- file.path("../..", config$meta$sampling$sample_data_file)
}
sample_data <- read.table(sample_data_file, sep = ";", header = TRUE)
